...
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified selectCityButton;
...
@interface AddNewCustomerViewController (SWIFT_EXTENSION(PaymentManagement)) <UITextFieldDelegate>
